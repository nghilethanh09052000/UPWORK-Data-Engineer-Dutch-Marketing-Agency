...
class StartPeopleScraper(BaseAgencyScraper):
    ...
    PAGES_TO_SCRAPE: List[Dict[str, Any]] = [
        ...
        {
            "name": "werkgevers",
            "url": "https://www.startpeople.nl/werkgevers",
            "functions": ['sectors'],
        },
        {
            "name": "contact",
            "url": "https://www.startpeople.nl/contact",
            "functions": ['contact'],
        },
        {
            "name": "privacy",
            "url": "https://www.startpeople.nl/privacy-statement",
            "functions": ['legal'],
        },
    ]
    ...
    def _apply_functions_normal(
        ...
        for func_name in functions:
            if func_name == "logo":
                ...
                legal_name = self.utils.fetch_legal_name(page_text, "Start People", url)
                if kvk:
