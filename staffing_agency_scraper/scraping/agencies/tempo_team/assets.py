...
class TempoTeamScraper(BaseAgencyScraper):
    ...
    PAGES_TO_SCRAPE: List[Dict[str, Any]] = [
        ...
        {
            "name": "werkgevers",
            "url": "https://www.tempo-team.nl/werkgevers",
            "functions": ['sectors'],
        },
        {
            "name": "contact",
        ...
        {
            "name": "voorwaarden",
            "url": "https://www.tempo-team.nl/over-tempo-team/voorwaarden",
            "functions": ['legal'],
        },
    ]
    ...
    def _apply_functions(
        ...
        for func_name in functions:
            if func_name == "logo":
                ...
                legal_name = self.utils.fetch_legal_name(page_text, "Tempo-Team", url)
                if kvk:
