...
class YoungCapitalScraper(BaseAgencyScraper):
    ...
    PAGES_TO_SCRAPE = [
        ...
        "https://www.youngcapital.nl/over-ons",
        "https://www.youngcapital.nl/contact",
    ]
    ...
    def scrape(self) -> Agency:
        ...
        try:
            ...
            contact_link = self.find_page_url(
                werkgevers_page, ["contact", "offerte", "aanvragen"]
            )
            if contact_link:
        ...
        # Scrape about page
        try:
            about_page = self.fetch_page(f"{self.WEBSITE_URL}/over-ons")
